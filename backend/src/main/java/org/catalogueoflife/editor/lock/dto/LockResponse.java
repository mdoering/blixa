 ...
 * takeover. discussionId/discussionTitle are the optional objective behind the lock (null when none
 * was given) -- discussionTitle is joined in by LockMapper's read queries so the lock list shows
 * *why* an entity is locked without a separate lookup.
 */
public record LockResponse(Integer id, String entityType, Integer entityId, Integer userId,
    ...
    Integer discussionId, String discussionTitle) {}
