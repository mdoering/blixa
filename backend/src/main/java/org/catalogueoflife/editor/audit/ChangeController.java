...
public class ChangeController {
  ...
  public List<Change> list(@PathVariable int pid,
      ...
      @RequestParam(required = false) Integer discussionId,
    ...
    if (discussionId != null) {
      // discussionId takes precedence over the entity filters -- a grouped-by-objective view of
      // the changelog has no reason to also narrow by entity.
      return changes.findByDiscussion(pid, discussionId, clampedLimit, clampedOffset);
    }
    if (entityId != null) {
