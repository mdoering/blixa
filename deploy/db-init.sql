-- One-time provisioning for Blixa on a native PostgreSQL 17 (the GBIF dev setup).
...
CREATE ROLE blixa WITH LOGIN PASSWORD :pw;
...
-- even though the blixa role can't create extensions.
